...
/**
 * @extends ServiceEntityRepository<NewsletterContact>
 *
...
class NewsletterContactRepository extends ServiceEntityRepository
{
    ...
    public function save(NewsletterContact $entity, bool $flush = false): void
    {
    ...
    public function remove(NewsletterContact $entity, bool $flush = false): void
    {
